# Autogenerated wrapper script for MAGEMin_jll for aarch64-apple-darwin-libgfortran5
...
function __init__()
    JLLWrappers.@generate_init_header(NLopt_jll, CompilerSupportLibraries_jll)
